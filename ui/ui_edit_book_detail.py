...
class Ui_edit_book_detail(object):
    def setupUi(self, edit_book_detail):
        ...
        self.gridLayout.addWidget(self.lineEdit_version, 7, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.lineEdit_price, 8, 1, 1, 2)
        ...
        self.gridLayout.addWidget(self.lineEdit_vip_price, 9, 1, 1, 2)
